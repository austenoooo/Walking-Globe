...
function createGeometry() {
  ...
  let buildingAmbient = textureLoader.load(
    "./textures/010_ambientOcclusion.jpg"
  );
  ...
  groundMesh = new THREE.Mesh(
    new THREE.SphereGeometry(ground_radius, 64, 32),
    materialGround
  );
  ...
  for (var n = 0; n < 100; n++) {
    loader.load(
      ...
      function (gltf) {
        ...
        // rotate the pivot instead of the buildling
